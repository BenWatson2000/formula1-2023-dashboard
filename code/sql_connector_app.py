...
def set_all_zero(cursor,mydb):
    query = """UPDATE F1Drivers
                ...
                WHEN drivername = 'Lewis Hamilton' THEN 0
                WHEN drivername = 'George Russell' THEN 0
                WHEN drivername = 'Max Verstappen' THEN 0
                WHEN drivername = 'Sergio Perez' THEN 0
                WHEN drivername = 'Charles Leclerc' THEN 0
                WHEN drivername = 'Carlos Sainz' THEN 0
                WHEN drivername = 'Pierre Gasly' THEN 0
                WHEN drivername = 'Esteban Ocon' THEN 0
                WHEN drivername = 'Nyck de Vries' THEN 0
                WHEN drivername = 'Yuki Tsunoda' THEN 0
                WHEN drivername = 'Lando Norris' THEN 0
                WHEN drivername = 'Oscar Piastri' THEN 0
                WHEN drivername = 'Fernando Alonso' THEN 0
                WHEN drivername = 'Lance Stroll' THEN 0
                WHEN drivername = 'Valtteri Bottas' THEN 0
